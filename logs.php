...
const ACTION_LABELS = {
    ...
    'submission_created': { label: 'إنشاء Submission', color: 'bg-cyan-100 text-cyan-700', icon: 'fas fa-inbox' },
    'submission_updated': { label: 'تحديث Submission', color: 'bg-sky-100 text-sky-700', icon: 'fas fa-file-pen' },
    'submission_changes_requested': { label: 'طلب تعديل Submission', color: 'bg-amber-100 text-amber-700', icon: 'fas fa-rotate-left' },
    'submission_rejected': { label: 'رفض Submission', color: 'bg-slate-200 text-slate-700', icon: 'fas fa-ban' },
    'submission_converted': { label: 'تحويل Submission', color: 'bg-emerald-100 text-emerald-700', icon: 'fas fa-arrow-right-from-bracket' },
